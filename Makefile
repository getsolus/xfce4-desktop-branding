...
install-live:
	...
	cp overrides/livecd/xfce4-panel.xml $(DESTDIR)/usr/share/xdg/xdg-solus-xfce/xfce4/xfconf/xfce-perchannel-xml/

install:
	mkdir -pv $(DESTDIR)/usr/share/xdg/xdg-solus-xfce/xfce4/xfconf/xfce-perchannel-xml/
	cp overrides/*.xml $(DESTDIR)/usr/share/xdg/xdg-solus-xfce/xfce4/xfconf/xfce-perchannel-xml/